      ...
      <Container>
        <Row className="mt-4">
          ...
          <Col xs={10} lg={12} className="mt-4 white-div">
            <h1 className="order-title">Edit Product</h1>
            ...
            <Form onSubmit={submitHandler}>
                ...
                <Col lg={9} className="col-border-dashed">
                  ...
                  <label htmlFor="file" className="label-upload-1">
                    <h1 className="create-order-text2 mt-3">
                      Edit current images or browse new ones
                    </h1>
                  </label>
                  <Row className="mt-4 mx-1">
                    {selectedImages.map((pics) => (
                      <Col xs={6} md={3} className="upload-img-col" key={pics}>
                        <img
                          src={pics}
                          alt="pics"
              ...
              <Link to="/view-product">
                <Button className={classes.backBtn}>Cancel</Button>
              </Link>
            </Form>
          </Col>
        </Row>
